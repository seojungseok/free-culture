...
export default async function RegionPage({params}:{params:Promise<{code:string}>}){
 ...
 const freeEvents=getByRegion(area).filter(e=>e.priceType==='free'&&e.startDate<=weekend.end&&e.endDate>=weekend.start);
