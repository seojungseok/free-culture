...
export const metadata: Metadata = { title: "반려동물 동반 여행지 | 강아지와 가볼만한곳 - 오늘은 뭐하지", description: "서울, 경기, 부산, 제주 등 전국 반려동물 동반 관광지와 산책 장소를 지역과 유형별로 찾아보세요.", keywords: ["반려동물 여행", "반려동물 동반 여행", "강아지와 가볼만한곳", "애견동반 관광지", "반려견 산책"], alternates: { canonical: "/pet-travel" } };
