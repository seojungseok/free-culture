...
export default function PrivacyPage() {
  return (
    <div className="prose-page">
      ...
      <p>
        &ldquo;내 위치로 찾기&rdquo; 등 위치 기반 기능은 이용자가 버튼을 누르고 브라우저의
        위치 권한을 허용한 경우에만 현재 위치 좌표를 사용합니다. 좌표는 주변 장소 검색
        요청을 처리하는 데 사용되며, 위치 권한을 허용하지 않아도 지역을 직접 선택해
        서비스를 이용할 수 있습니다.
      </p>
      ...
      <h2>보관함의 브라우저 저장</h2>
      <p>
        보관함은 선택한 장소·일정·방문 날짜를 이용자의 브라우저 localStorage에 저장합니다.
        보관함 내용을 서버 데이터베이스에 전송하거나 다른 기기와 동기화하지 않습니다.
        보관함에서 항목을 삭제하거나 브라우저의 사이트 데이터를 지우면 제거됩니다.
        공용 기기에서는 이용 후 저장한 항목을 삭제해 주세요.
      </p>
