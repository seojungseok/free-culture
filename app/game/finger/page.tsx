...
export const metadata: Metadata = {
  ...
  description:
    "다 같이 화면에 손가락을 올리면 가운데서 뱀이 나와 손가락 사이를 돌아다니다 한 명을 콱! 물어요. 물린 사람이 독박! 최대 8명, 휴대폰 하나로 즐기는 긴장감 넘치는 무료 손가락 뱀 룰렛.",
  ...
  return (
    <div className="min-h-screen bg-[#0b0b18] bg-[radial-gradient(circle_at_15%_0%,rgba(177,75,255,0.22),transparent_45%),radial-gradient(circle_at_90%_10%,rgba(0,229,255,0.14),transparent_40%)] text-white">
      ...
      <div className="mx-auto w-full max-w-[1000px] px-5 py-8 sm:px-6">
        ...
        <p className="mt-1 text-[14px] text-white/60">다 같이 손가락을 올리면 가운데서 뱀이 나와 돌아다니다 <b className="text-white">한 명을 콱! 물어요.</b> 물린 사람이 독박! <b className="text-white">최대 8명.</b></p>
