...
export const metadata: Metadata = {
  ...
  description:
    "친구·회식·술자리에서 벌칙 정할 때! 이름만 입력하면 끝나는 무료 독박게임 18종 — 룰렛·사다리·주사위·폭탄·벌칙룰렛·손가락·반응속도·슬롯·풍선·타이머·바스톱·러시안룰렛·연타·데시벨·숫자폭탄·기억력순서·뱀잡기. 설치 없이 바로.",
...
const GAMES = [
  ...
  { href: "/game/catch", emoji: "🐍", name: "뱀 잡기", desc: "도망치는 뱀 잡기, 제일 적으면 독박", accent: "from-emerald-500 to-green-600", ready: true },
