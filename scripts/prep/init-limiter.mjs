...
const state={cap:Math.min(10,Math.max(1,Math.floor(Number(process.env.COUPANG_WINDOW_CAP)||10))),window:Math.max(60000,Number(process.env.COUPANG_WINDOW_MS)||60000),interval:Math.max(6100,Number(process.env.COUPANG_MIN_INTERVAL_MS)||6100),nextAt:0,events:[]};
