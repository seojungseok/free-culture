...
const configs = [
 ...
 ['camp-samgyeopsal-bbq-ingredient-checklist','캠핑 삼겹살 바비큐 재료 체크리스트','삼겹살 바비큐를 계획할 때 조리판·집게·곁들임 채소를 출발 전에 확인하는 준비물 체크리스트.','삼겹살·바비큐',['9587833030','9707359364','8443644467','8655440206'],'삼겹살 바비큐 준비물'],
...
const editorial = {
 ...
 'camp-samgyeopsal-bbq-ingredient-checklist':'삼겹살은 출발 직전 정육 판매처에서 부위와 냉장 보관 상태를 따로 확인합니다. 조리판과 집게는 식재료와 분리하고, 애호박과 버섯은 물기 없이 곁들임 재료 상자에 넣습니다.',
