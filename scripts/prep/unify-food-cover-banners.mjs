...
for(const article of store.articles.filter(a=>a.salesFormat==='food-checklist')){
 ...
 const source=path.join(root,'public','prep-images',`${sourceBase}.webp`);
