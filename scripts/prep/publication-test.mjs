...
try{
 ...
 const listing=await page('/weekend-prep');assert(!listing.includes('noindex'));for(const c of new Set(store.articles.map(a=>a.category)))assert(listing.includes(c));
