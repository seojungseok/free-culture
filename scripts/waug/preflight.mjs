...
for(const day of new Set(e.history.map(h=>h.day)))assert.ok(e.history.filter(h=>h.day===day).length<=(policy.historicalPublicationAllowances?.[day]?.limit||policy.dailyAdditionalLimit||20),day);
