...
export default function HeaderNav({ seasonLabel }: { seasonLabel: string }) {
  ...
  const tabs: { href: string; label: string; path: string }[] = [
    { href: "/#home-category-events", label: "문화행사", path: "/events" },
    { href: "/#home-category-places", label: "나들이", path: "/places" },
    { href: "/#home-category-course", label: "여행코스", path: "/course" },
    { href: "/#home-category-camping", label: "캠핑", path: "/camping" },
    { href: "/#home-category-food", label: "맛집탐방", path: "/food" },
    { href: "/#home-category-kids", label: "아이와함께", path: "/kids" },
    { href: "/#home-category-date", label: "데이트", path: "/date" },
    { href: "/#home-category-season", label: `${seasonLabel}나들이`, path: "/season" },
  ];
