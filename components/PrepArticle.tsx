...
const cookingGuides:Record<string,CookingGuideData>={
 ...
 'autumn-20260920-soy-butter-potato-grill':{title:'간단한 간장버터감자구이 만드는 방법',links:{'감자':'9656363105','무염 버터':'7847571181','진간장':'7235302196','대파':'6528172171'},steps:['감자는 깨끗이 씻어 비슷한 크기로 자르고 물기를 닦습니다.','예열한 팬에 기름을 조금 두르고 감자와 양파를 먼저 노릇하게 익힙니다.','감자가 익으면 무염 버터와 진간장을 조금씩 더해 뒤섞고 대파를 마무리에 올립니다.','감자의 익힘 정도와 버터·간장 사용량은 먹는 인원과 팬 크기에 맞춰 조절하세요.']},
 'autumn-20260920-shrimp-jeon':{title:'간단한 새우전 만드는 방법',links:{'칵테일새우':'1761375156','달걀':'8326848865','부침가루':'6269223291','식용유':'487322'},steps:['칵테일새우는 포장 안내에 따라 해동·준비하고 물기를 닦습니다.','새우에 부침가루를 얇게 묻힌 뒤 달걀물을 입혀 주세요.','예열한 팬에 식용유를 소량 두르고 앞뒤를 노릇하게, 중심까지 충분히 익힙니다.','새우의 해동·가열과 달걀 보관은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-mushroom-cheese-grill':{title:'간단한 버섯치즈구이 만드는 방법',links:{'새송이버섯':'8655440206','무염 버터':'7847571181','체다 슬라이스 치즈':'6959448489','양파':'9457848435'},steps:['새송이버섯은 비슷한 두께로 썰고 양파와 파프리카를 준비합니다.','예열한 팬에 무염 버터를 조금 녹여 버섯을 먼저 굽습니다.','버섯이 노릇해지면 채소를 더하고 불을 낮춘 뒤 체다 슬라이스 치즈를 올려 녹입니다.','버섯의 상태와 치즈의 보관·가열은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-tofu-soy-grill':{title:'간단한 두부간장구이 만드는 방법',links:{'촌두부':'7867851377','진간장':'7235302196','다진마늘':'7673804291','대파':'6528172171'},steps:['촌두부는 포장 안내를 확인한 뒤 꺼내 겉물기를 닦고 도톰하게 자릅니다.','예열한 팬에 기름을 소량 두르고 두부의 앞뒤를 먼저 단단하게 굽습니다.','노릇해진 뒤 진간장과 다진마늘을 조금씩 더하고, 대파는 마지막에 올립니다.','두부의 보관·가열과 양념 사용량은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-kimchi-fishcake-stirfry':{title:'간단한 김치어묵볶음 만드는 방법',links:{'포기김치':'7692122826','모둠 어묵':'8682238562','진간장':'7235302196','대파':'6528172171'},steps:['포기김치는 먹기 좋게 자르고 모둠 어묵은 포장 안내에 따라 준비합니다.','예열한 팬에 양파와 김치를 먼저 볶아 수분을 날려 주세요.','어묵을 더해 충분히 데운 뒤 진간장은 맛을 보며 소량씩 넣고 대파로 마무리합니다.','김치·어묵의 보관과 가열은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-jeyuk-bokkeum-ingredient-checklist':{title:'간단한 제육볶음 만드는 방법',links:{'고추장 제육볶음':'8987385839','제육용 돼지고기':'7265684367','볶음소스':'7404695153','대파':'6528172171'},steps:['고추장 제육볶음과 제육용 돼지고기는 포장 안내에 따라 준비하고, 양파와 대파는 먹기 좋게 썹니다.','예열한 팬에 양파를 먼저 볶은 뒤 돼지고기를 넣어 중심까지 충분히 익혀 주세요.','볶음소스는 일부부터 넣어 수분과 간을 보며 볶고, 대파는 마지막에 더합니다.','고기의 보관·가열과 소스 사용량은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-sundae-bokkeum-ingredient-checklist':{title:'간단한 순대볶음 만드는 방법',links:{'찰순대':'8960028100','순대볶음 구성':'6645728981','만능양념장':'6854193615','대파':'6528172171'},steps:['찰순대와 순대볶음 구성은 포장 안내에 따라 준비하고 양파와 대파는 먹기 좋게 썹니다.','팬에 양파를 먼저 볶아 수분을 줄이고 만능양념장은 조금씩 넣어 맛을 맞춥니다.','채소와 양념이 어우러진 뒤 순대를 넣어 충분히 데우고 대파로 마무리합니다.','순대의 보관·가열과 양념 사용량은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-dakgalbi-ingredient-checklist':{title:'간단한 춘천 닭갈비 만드는 방법',links:{'양념 닭갈비':'344228023','새송이버섯':'8655440206','파프리카':'7935223581','대파':'6528172171'},steps:['양념 닭갈비는 포장 안내에 따라 준비하고 새송이버섯·파프리카·대파는 먹기 좋게 썹니다.','예열한 그리들에 양념 닭갈비를 먼저 올려 뒤집어 가며 중심까지 충분히 익힙니다.','버섯과 양파를 더해 익힌 뒤 파프리카와 대파를 마지막에 넣어 짧게 볶아 주세요.','닭의 보관·가열은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-chicken-kimchi-fried-rice-ingredient-checklist':{title:'간단한 닭가슴살 김치볶음밥 만드는 방법',links:{'닭가슴살 김치볶음밥':'68121544','배추김치':'7692122826','즉석밥':'7488621084','달걀':'8326848865'},steps:['배추김치와 대파는 잘게 썰고 닭가슴살 김치볶음밥과 즉석밥은 포장 안내에 따라 준비합니다.','예열한 팬에 김치와 대파를 먼저 볶아 수분을 정리한 뒤 밥을 넣어 고루 풀어가며 볶습니다.','달걀은 따로 익혀 곁들이거나 팬 가장자리에서 함께 익혀 마무리합니다.','볶음밥·즉석밥의 가열과 달걀 보관은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
 'autumn-20260920-mussel-seaweed-soup-ingredient-checklist':{title:'간단한 홍합미역국 끓이는 방법',links:{'손질 홍합살':'7430379988','국물육수 다시팩':'57577364','양파':'9457848435','대파':'6528172171'},steps:['마른 미역은 물에 불린 뒤 헹구고 손질 홍합살은 포장 안내에 따라 준비합니다.','냄비에 물과 국물육수 다시팩을 넣어 국물 바탕을 낸 뒤 양파와 미역을 넣어 끓입니다.','국물이 끓으면 홍합살을 넣어 충분히 데우고 대파를 마지막에 더하세요.','홍합살의 해동·가열과 육수 사용량은 구매한 제품의 포장 안내를 우선으로 확인하세요.']},
};
...
function CookingGuide({article,products}:{article:Article;products:PrepProduct[]}){
 ...
 const linkText=(text:string)=>!AFFILIATE_ENABLED?text:text.split(pattern).map((part,index)=>{const p=productMap.get(guide.links[part]);return p?<a key={`${part}-${index}`} href={p.affiliateUrl} target="_blank" rel="sponsored noopener">{part}</a>:part;});
...
export default function PrepArticle({article:a,products,preview=false,relatedArticles=[]}:{article:Article;products:PrepProduct[];preview?:boolean;relatedArticles?:{slug:string;title:string}[]}){
 ...
 return <article className="prep-article">
  ...
  {AFFILIATE_ENABLED&&<p className="prep-disclosure">이 글에는 제휴 링크가 포함되어 있습니다. 쿠팡 파트너스 활동의 일환으로, 이에 따른 일정액의 수수료를 제공받을 수 있습니다.</p>}
  ...
  {a.salesFormat!=='food-checklist'&&a.sections.map((s,i)=>{
   ...
   if(AFFILIATE_ENABLED)for(const id of s.productIds){const p=chosen.find(p=>p.id===id);if(!p||linked.has(id))continue;for(let k=0;k<parts.length;k++){const part=parts[k];if(typeof part!=='string'||!part.includes(p.name))continue;const pos=part.indexOf(p.name);parts.splice(k,1,part.slice(0,pos),<a key={id} href={p.affiliateUrl} target="_blank" rel="sponsored noopener">{p.name}</a>,part.slice(pos+p.name.length));linked.add(id);break;}}
   return <p className={isPoint?'prep-point':undefined} key={j}>{parts}</p>;
  })}{a.salesFormat!=='food-checklist'&&AFFILIATE_ENABLED&&sectionProducts.length>0&&<div className="prep-buy-grid">{sectionProducts.map(p=><a className="prep-buy-card" key={p.id} href={p.affiliateUrl} target="_blank" rel="sponsored noopener"><Image src={p.image} alt="" width={74} height={74} unoptimized/><span><strong>{p.name}</strong><small>{actionLabel} →</small></span></a>)}</div>}{s.image&&<PrepImage photo={s.image} products={chosen}/>}</section>})}
  {a.salesFormat!=='food-checklist'&&AFFILIATE_ENABLED&&<section className="prep-image-links"><h2>사진 속 +로 상품 확인하기</h2><p>사진에 표시된 +를 누르면 해당 재료나 제품의 쿠팡 페이지가 열립니다.</p></section>}
  {a.salesFormat!=='food-checklist'&&!!a.internalLinks.length&&<nav aria-label="함께 읽기"><h2>함께 보면 좋은 곳</h2>{a.internalLinks.map(l=><p key={l.href}><Link href={l.href}>{l.label} →</Link></p>)}</nav>}
  {a.salesFormat!=='food-checklist'&&<p className="prep-ai-note">{a.imageConnectionNote || '이 글의 이미지는 AI를 활용해 제작했습니다.'}</p>}
 </article>;
}
